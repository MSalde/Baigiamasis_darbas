...
public class Vartotojas {
    ...
    public Vartotojas(long id, String username, String password, String vardas, String pavarde, boolean enabled, boolean expiredToken, Set<Komentarai> komentarai, Set<Role> roles) {
        this.id = id;
